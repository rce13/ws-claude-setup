...
**生物学・老化医学・転写の観点で興味深い所見を見出すことが目的。統計はそのための道具であって目的ではない。**

- **統計は「論文として通る程度」で十分。**それ以上の検証に時間と会話を費やさない
- **報告は生物学の言葉で書く。**遺伝子名・細胞・現象を主語にする。
  p 値・OR・マッチング手法の話に終始した報告は失敗とみなす
- **数字を出すときは、それが生物学的に何を意味するかを必ず添える。**
  「OR 9.52 (p=0.0079)」だけで止めない。「この素子群に T 細胞の身元を決める遺伝子が集まっている」まで書く
- **具体名を出す。**「90 遺伝子が濃縮」ではなく「ZEB2, PRDM1, KLF6, LMNA, IL15 が並ぶ」と書く
- 交絡の検証は必要だが、**一度潰したら次へ進む。**同じ懸念を何度も検証し直さない
- 陰性結果も同じ姿勢で扱う。**「有意でなかった」で止めず、生物学的に何が言えるか**まで踏み込む

★ 過去の失敗: 交絡検証を繰り返すうちに会話が統計の話ばかりになり、
「結局どういう生物が起きているのか」が見えなくなった。**面白さを先に、検証は後ろに。**
